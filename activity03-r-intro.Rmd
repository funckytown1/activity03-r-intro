...
**Response**: The errors were missing commas so I just looked for them at the red lines
...
**Response**: c bind didn't like the parameter size and looked at the value of my_symbols and saw it had columns so just tried creating a vector made up of all 3 vectors
...
**Response**: dataframe not found so I just looked up the right function name and changed = to
